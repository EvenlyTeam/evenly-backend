...
class AuthController {
    ...
    @Operation(summary = "회원가입", description = "가입 후 access 토큰(바디) + refresh 토큰(httpOnly 쿠키) 발급.")
    @ApiResponses({
    ...
    @Operation(summary = "로그인", description = "자격 증명 검증 후 access 토큰(바디) + refresh 토큰(httpOnly 쿠키) 발급.")
    @ApiResponses({
    ...
    @Operation(summary = "로그아웃", description = "refresh 쿠키를 만료시킨다.")
