...
class ShareLinkController {
    ...
    ShareLinkController(GenerateShareLinkUseCase generateShareLinkUseCase) {
    ...
    @PostMapping
    public ShareLinkInfo generateShareLink(@Parameter(description = "모임 ID") @PathVariable UUID groupId) {
